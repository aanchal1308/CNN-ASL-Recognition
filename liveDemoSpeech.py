...
def text_mode(cam):
	...
	while True:
		...
		if is_voice_on:
			cv2.putText(blackboard, "Voice on", (550, 540), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 127, 0))
		else:
			cv2.putText(blackboard, "Voice off", (550, 540), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 127, 0))
